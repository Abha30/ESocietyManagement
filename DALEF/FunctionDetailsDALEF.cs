...
namespace DALEF
{
    public class FunctionDetailsDALEF : IFunction
    {
        ...
        public IEnumerable<FunctionDetails> GetFunctionDetails()
        {
            try
            {
                ...
                foreach (var r in res)
                {
                    ...
                    fs.Function_Category_ID = (int)r.Function_Category_ID;
                    fs.Owner_ID = (int)r.Owner_ID;
        ...
        public FunctionDetails GetByIdFunctionDetails(int id)
        {
            try
            {
